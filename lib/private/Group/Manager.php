...
class Manager extends PublicEmitter implements IGroupManager {
	...
	public function getUserIdGroups($uid) {
		...
		foreach($this->getUserIdGroupIdsAndBackends($uid) as $groupId => $backend) {
			$aGroup = $this->get($groupId);
			if ($aGroup instanceof IGroup) {
				$groups[$groupId] = $aGroup;
			} else {
	...
	public function isInGroup($userId, $group) {
		return array_key_exists($group, $this->getUserIdGroupIdsAndBackends($userId));
	}
	...
	public function getUserGroupIds(IUser $user) {
		return array_keys($this->getUserIdGroupIdsAndBackends($user->getUID()));
	}
	 ...
	 */
	private function getUserIdGroupIdsAndBackends($uid) {
